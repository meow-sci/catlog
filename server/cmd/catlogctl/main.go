...
var verbs = []verb{
	...
	{name: "shadowban", wp: "WP-SB", help: "withhold a player's log and hide them, without telling them", run: runShadowban},
	{name: "unshadowban", wp: "WP-SB", help: "give a shadowbanned player's log back", run: runUnshadowban},
	{name: "shadowban-list", wp: "WP-SB", help: "the shadow-ban roster and how much is withheld", run: runShadowbanList},
	{name: "shadowban-review", wp: "WP-SB", help: "read a shadowbanned player's withheld events", run: runShadowbanReview},
	{name: "shadowban-delete", wp: "WP-SB", help: "destroy a shadowbanned player's withheld events, permanently", run: runShadowbanDelete},
	...
	{name: "rebuild", wp: "WP4", help: "rebuild projections from seq 0 and swap it in, following the job", run: runRebuild},
